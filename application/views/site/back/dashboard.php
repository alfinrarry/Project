			...
			<div class="card">
				<div class="card-body">
					...
					<ul class="list-inline m-t-30 text-center font-12">
						...
						<li class="list-inline-item text-muted"><i class="fa fa-circle text-success m-r-5"></i> MaterialPro Admin
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="col-lg-4 col-md-12">
			<div class="card bg-info">
				<div class="card-body mb-0">
					<h4 class="card-title text-white">Thursday <span class="font-14 font-normal text-white op-5">12th April,
							2018</span></h4>
					...
					<div class="m-t-20 m-b-10">
						<ul class="list-style-none m-t-10">
							<li>
								<div class="d-flex align-items-center">
									<div>
										<h4 class="mb-0 font-medium text-white">58% <span
												class="font-normal font-14 text-white op-5 m-l-5">New Users</span></h4>
									</div>
								</div>
								<div class="progress m-t-10 user-progress-bg">
									<div class="progress-bar bg-white" role="progressbar" style="width: 58%" aria-valuenow="58"
							...
							<li class="m-t-30">
								<div class="d-flex align-items-center">
									<div>
										<h4 class="mb-0 font-medium text-white">16% <span
												class="font-normal font-14 text-white op-5 m-l-5">Repeat Users</span></h4>
									</div>
								</div>
								<div class="progress m-t-10 user-progress-bg">
									<div class="progress-bar bg-white" role="progressbar" style="width: 16%" aria-valuenow="16"
										aria-valuemin="0" aria-valuemax="100"></div>
								</div>
							</li>
						</ul>
			...
			<div class="card">
				...
				<div class="comment-widgets scrollable" style="height:430px;">
					...
					<div class="d-flex flex-row comment-row m-t-0">
						<div class="p-2">
							<img src="<?php echo vendor_url('back/images/users/1.jpg'); ?>" alt="user" width="50" class="rounded-circle">
						</div>
					...
					<div class="d-flex flex-row comment-row">
						<div class="p-2">
							<img src="<?php echo vendor_url('back/images/users/4.jpg'); ?>" alt="user" width="50" class="rounded-circle">
						</div>
					...
					<div class="d-flex flex-row comment-row">
						<div class="p-2">
							<img src="<?php echo vendor_url('back/images/users/5.jpg'); ?>" alt="user" width="50" class="rounded-circle">
						</div>
						<div class="comment-text w-100">
					...
					<div class="d-flex flex-row comment-row m-t-0">
						<div class="p-2">
							<img src="<?php echo vendor_url('back/images/users/2.jpg'); ?>" alt="user" width="50" class="rounded-circle">
						</div>
						<div class="comment-text w-100">
							...
							<li class="list-group-item todo-item" data-role="task">
								<div class="custom-control custom-checkbox">
									...
									<label class="custom-control-label todo-label" for="customCheck">
										<span class="todo-desc">Simply dummy text of the printing and typesetting</span> <span
							...
							<li class="list-group-item todo-item" data-role="task">
								<div class="custom-control custom-checkbox">
									...
									<label class="custom-control-label todo-label" for="customCheck1">
										<span class="todo-desc">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
											Lorem Ipsum has been.</span><span class="badge badge-pill badge-danger float-right">Project</span>
									</label>
								</div>
							...
							<li class="list-group-item todo-item" data-role="task">
								<div class="custom-control custom-checkbox">
									...
									<label class="custom-control-label todo-label" for="customCheck2">
										<span class="todo-desc">Ipsum is simply dummy text of the printing</span> <span
							...
							<li class="list-group-item todo-item" data-role="task">
								<div class="custom-control custom-checkbox">
									...
									<label class="custom-control-label todo-label" for="customCheck4">
										<span class="todo-desc">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
											Lorem Ipsum has been.</span> <span
