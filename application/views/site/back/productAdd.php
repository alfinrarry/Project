            ...
            <div class="row">
              ...
              <div class="col-sm-12 col-md-8">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="title_product" id="title_product" required <?php if($isEdit) echo "value='".$data['title_product']."'"?>>
                </div>
              </div>
              <!-- End Product Name -->
              <!-- Category -->
              ...
              <div class="col-sm-6 col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control" name="length" id="length" value="">
                  </div>
                </div>
              </div>
              <!-- End Product lenght -->
              ...
              <div class="col-sm-6 col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control" name="width" value="" id="width">
                  </div>
                </div>
              </div>
              <!-- End Product width -->
                  ...
                  <div class="row m-t-20">
                    <div class="col-sm-4">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="variation[]" value="" id="variation">
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="input-group">
                        ...
                        <input type="number" class="form-control" name="qty[]" value="" id="qty">
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="input-group">
